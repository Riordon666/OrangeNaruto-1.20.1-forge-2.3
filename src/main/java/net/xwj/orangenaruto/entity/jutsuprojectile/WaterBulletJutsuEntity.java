package net.xwj.orangenaruto.entity.jutsuprojectile;

import net.xwj.orangenaruto.damagetypes.NarutoDamageTypes;
import net.xwj.orangenaruto.entity.NarutoEntities;
import net.xwj.orangenaruto.entity.projectile.AbstractNonGlowingHurtingProjectile;
