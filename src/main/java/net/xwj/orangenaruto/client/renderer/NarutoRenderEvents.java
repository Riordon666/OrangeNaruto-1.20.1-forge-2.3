...
import net.xwj.orangenaruto.client.model.jutsu.FireballJutsuModel;
import net.xwj.orangenaruto.client.model.jutsu.WaterBulletModel;
import net.xwj.orangenaruto.client.renderer.entity.*;
import net.xwj.orangenaruto.client.renderer.entity.jutsuprojectile.FireballJutsuRenderer;
import net.xwj.orangenaruto.client.renderer.entity.jutsuprojectile.WaterBulletJutsuRenderer;
...
@Mod.EventBusSubscriber(value=Dist.CLIENT, modid= OrangeNaruto.MODID, bus= Mod.EventBusSubscriber.Bus.MOD)
