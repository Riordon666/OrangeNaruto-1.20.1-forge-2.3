package net.xwj.orangenaruto.client.renderer.entity.jutsuprojectile;
...
public class WaterBulletJutsuRenderer extends EntityRenderer<WaterBulletJutsuEntity> {
   public static final ResourceLocation WATER_BULLET_TEX = new ResourceLocation("orangenaruto", "textures/entity/jutsu/projectiles/water_bullet.png");
