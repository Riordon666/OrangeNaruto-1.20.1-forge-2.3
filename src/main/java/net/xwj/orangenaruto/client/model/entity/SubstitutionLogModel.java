package net.xwj.orangenaruto.client.model.entity;
...
public class SubstitutionLogModel<T extends Entity> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(OrangeNaruto.MODID, "substitution_log"), "main");
