...
public class AnbuMaskModel<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION_WITHOUT_EARS =
            new ModelLayerLocation(new ResourceLocation(OrangeNaruto.MODID, "anbu_mask_without_ears"), "main");

    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(new ResourceLocation(OrangeNaruto.MODID, "anbu_mask"), "main");
