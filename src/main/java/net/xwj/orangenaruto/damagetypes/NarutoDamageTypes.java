...
public class NarutoDamageTypes {
    ...
    public static final ResourceKey<DamageType> WATER_BULLET = ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(OrangeNaruto.MODID, "water_bullet"));

    public static ResourceKey<DamageType> create(String name) {
        return ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(OrangeNaruto.MODID, name));
    }
