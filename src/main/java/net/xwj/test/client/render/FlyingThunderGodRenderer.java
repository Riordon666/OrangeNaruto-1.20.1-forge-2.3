package net.xwj.test.client.render;
...
public class FlyingThunderGodRenderer extends EntityRenderer<FlyingThunderGodEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(test.MODID, "textures/entity/flying_thunder_god.png");
